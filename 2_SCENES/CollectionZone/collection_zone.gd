...
func begin_viewing_collection():
	...
	_on_viewing_card_clicked = func(card: Card, content_holder: ContentHolder):
		...
		new_grid(_show_pair, create_card_array_from_card(card, SortingBy))
	new_grid(_on_viewing_card_clicked, create_card_array(SortingBy))
...
func begin_building_deck(deck: Deck):
	...
	_on_deck_building_card_clicked = func(card: Card, content_holder: ContentHolder):
		var _select_pair = func(card: Card, content_holder: ContentHolder):
...
func create_card_array(SortOrder: ContentCollection.SortOrders, ShowPrimary : bool = true) -> Array[Card]:
...
func create_card_array_from_card(StartingCard: Card, SortOrder: ContentCollection.SortOrders, ShowPrimary : bool = true) -> Array[Card]:
	var cards : Array[Card] = []
	var side: String = "ATK" if ShowPrimary else "DEF"
